...
namespace EventSourcing.API.BackgroundServices
{
    public class ProductReadModelEventStore : BackgroundService
    {
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            // true:  EventAppeared exception firlamadı ise event gönderildi sayar. Otomatik.
            // false : Bu ise manueldir. Doğrulamayı biz arg1.Acknowledge(arg2.Event.EventId); kodu ile göndeririz.
